            ...
            <el-col :span="16" :offset="4">
                ...
                >
                    ...
                    <el-form-item class="button_submit">
                        <el-button @click="updateExperiment()"
                            >更新</el-button
                        >
                    </el-form-item>
                </el-form>
...
import { queryExperimentById, queryQuestionById, updateExperiment, isQuestionExist} from "@/api/getData";
...
export default {
    ...
    activated(){
        this.experiment_id = this.$route.params.id;
        this.getExperiment()
    },
    methods: {
        async getExperiment() {
            const table_data = await queryExperimentById({experiment_id:this.experiment_id});
            this.question_list = [];
