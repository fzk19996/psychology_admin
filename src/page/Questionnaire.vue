  ...
  <div id="questionnairePage">  
    ...
    <el-row v-if="result.answer.length > 0" type="flex" justify="left" align="middle" v-for="(topic, index) in Questionnaire.template.topic" :key="topic._id">
      <el-col>
        ...
        <el-row class="questionRow" v-if="topic.type === '录音'" type="flex" justify="left" align="middle" >
          
               <el-button @click="startRecord">开始录音</el-button>
               <el-button @click="stopRecord">结束录音</el-button>
        </el-row>
        <el-row class="questionRow" v-if="topic.type === '反应'" type="flex" justify="left" align="middle" >
